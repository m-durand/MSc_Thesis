...
%% # Portada de la tesis #
\include{tesis_tex/00-PaginaTitulo}

%% # Prefacios #
\preface
\include{tesis_tex/01-Gracias}
\include{tesis_tex/02-Abstract}
...
%% # Cap'itulos #
\cuerpo
\include{tesis_tex/03-Introduccion}
\include{tesis_tex/04-Problema}
\include{tesis_tex/04.5-AprendizajeReforzado}
\include{tesis_tex/05-SolucionesPrevias}
\include{tesis_tex/06-Complicacion}
\include{tesis_tex/07-ProductoDatos}
\include{tesis_tex/08-Resultados}
\include{tesis_tex/09-Conclusiones}

\appendix
%% Cap'itulos incluidos despues del comando \appendix aparecen como ap'endices
%% de la tesis.
\include{tesis_tex/ApendiceA}
\include{tesis_tex/ApendiceB}
